...
\begin{multicols}{5}
    ...
    $h_w(x_1, ..., x_k) = w_0x_0 + \sum_{i=1}^{k}w_i x_i$
        ...
        \begin{enumerate}
            ...
            \item choose random $1\leq i \leq n$
        ...
        \begin{enumerate}
            ...
            \item For each $1\leq i \leq n$:
                  \begin{enumerate}[label*=\arabic*.]
                      \item $\delta_i = y_i - h_w(x_i)$
                      \item $\Delta w= \sum_{i=1}^{n} \delta_i \cdot x_i$
                  \end{enumerate}
...
\begin{itemize}
    ...
    \item $l(h, D)=\frac{1}{2n}\sum_{i=1}^{n}( h(x_i) - y_i)^2$ (Mean Squared Error)\\
